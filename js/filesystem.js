var originalFilesystem="<d name='/' path='/'>\
            ...
            <f name='boot.img' path='/'>\
            <contents>this is boot img</contents>\
            </f>\
            <f name='kptools' path='/'>\
            <contents>direct use kptools</contents>\
            </f>\
            <f name='kpimg-android' path='/'>\
            <contents>kpimg for android</contents>\
            </f>\
            <f name='magiskboot' path='/'>\
            <contents>kpimg for android</contents>\
            </f>\
            <f name='fastboot' path='/'>\
            <contents>fastboot tools</contents>\
            </f>\
            </c>\
        </d>";
/*
